...
from PyQt5.QtWidgets import QWidget, QApplication, QLabel, QComboBox, QPushButton, QTextBrowser, QSpinBox, QMainWindow
...
class MyApp(QWidget):
    def __init__(self):
        ...
        zoom_in_button.move(685, 110)
        zoom_out_button.move(685, 160)
        ...
        # create textBrowser that shows OK/NG    # NGOK 표시 박스
        ...
        # create the box to show FPS / FPS 표시 box
        #self.textBrowser.resize(70, 40)
        #self.textBrowser.move(700,35)
