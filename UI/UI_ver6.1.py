...
class MyApp(QWidget):
    def __init__(self):
        ...
        comboBox.addItem('43QNED75')
        comboBox.addItem('43NANO77')
        comboBox.addItem('43UR80')
        comboBox.addItem('50NANO77')
        comboBox.addItem('50UR75')
        comboBox.addItem('50UR80')
        comboBox.addItem('55NANO77')
        comboBox.addItem('55UR75')
        comboBox.addItem('55UR80')
        comboBox.addItem('65NANO77')
        comboBox.addItem('65UR75')
        comboBox.addItem('65UR80')
        comboBox.addItem('65QNED90')
        comboBox.addItem('65QNED90')
        comboBox.addItem('70NANO77')
        comboBox.addItem('70UR75')
        comboBox.addItem('70UR80')
        comboBox.addItem('75NANO77')
        comboBox.addItem('75UR75')
        comboBox.addItem('75UR80')
        comboBox.addItem('75QNED90')
        comboBox.addItem('75QNED99')
        comboBox.addItem('86NANO77')
        comboBox.addItem('86UR75')
        comboBox.addItem('86UR80')
        comboBox.addItem('86QNED80')
        comboBox.addItem('86QNED90')
        comboBox.addItem('86QNED99')
