...
class ObjectDetection(QThread):
    ...
    def plot_boxes(self, results, frame):
        ...
        # connect to MyApp() to desplay NG/OK
        #self.UI = MyApp()
        for i in range(n):
            row = cord[i]
            if row[4] >= 0.2:
                ...
                if OKNG == 'NG':
                    okNG = 'NG'
                    print(okNG)
                    #self.MyApp.showOKNG() #무한루프 처리되는 듯..

                # connect to MyApp() to desplay NG/OK
                #self.UI = MyApp()
                #if OKNG == 'NG':
                #    okNG = 'NG'
                #    self.UI.textBrowser.setHtml(QCoreApplication.translate("mainWindow","<p align=\"center\">""<b>""<span style=\" font-size:30pt; color:red;\">NG</span></b></p>",None))
                #    print(okNG)

                #elif OkNG == 'OK':
                #    okNG = 'OK'
                #    self.UI.textBrowser.setHtml(QCoreApplication.translate("mainWindow","<p align=\"center\">""<b>""<span style=\" font-size:30pt; color:red;\">OK</span></b></p>",None))
        return frame
...
class MyApp(QWidget):
    def __init__(self):
        ...
        grid.addWidget(self.video_label_YOLO, 4, 0)
    ...
    def showOKNG(self):
        ...
        if okNG == 'NG':
            ...
            self.textBrowser.setHtml(QCoreApplication.translate("mainWindow","<p align=\"center\">""<b>""<span style=\" font-size:30pt; color:red;\">OK</span></b></p>",None))
        #self.textBrowser.setPlainText(okNG)
    ...
    def update_image(self, cv_img):
        ...
        self.video_label_YOLO.setPixmap(qt_img)
